...
export const metadata: Metadata = {
  title: "News and insights | Innovate AI HealthLab",
  description:
    "Read news, research insights, field stories, and partnership updates from Innovate AI HealthLab.",
};
        ...
        <div className="mx-auto w-[min(1180px,92vw)] py-12 sm:py-16 lg:py-18">
          ...
          <div className="mt-9 max-w-4xl">
            ...
            <h1 className="mt-7 max-w-3xl text-balance text-5xl leading-[1.02] font-bold sm:text-6xl lg:text-[4.2rem]">
              Stories and learning from across IAHL&apos;s work.
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
              Research insights, field stories, partnership updates, and news
              from the people and questions shaping IAHL&apos;s work.
            </p>
          </div>
        </div>
      </section>
